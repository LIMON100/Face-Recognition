...
recognizer.read("I:/1.232 Pora/ALL Projects/Face Detection/with real training/lmn try all face/imgzQ/fc/cntsrvr/recognizers/face-trainner.yml")


labels = {"person_name": 1}
with open("I:/1.232 Pora/ALL Projects/Face Detection/with real training/lmn try all face/imgzQ/fc/cntsrvr/pickles/face-labels.pickle", 'rb') as f:
...
def make_dataset(img):
    ...
    dir_n = "I:/1.232 Pora/ALL Projects/Face Detection/with real training/lmn try all face/imgzQ/fc/cntsrvr/new_dataset/p" + str(b1)
    os.mkdir(dir_n)
