...
face_cascade = cv2.CascadeClassifier('I:/1.232 Pora/ALL Projects/Face Detection/with real training/lmn try all face/All in/with class/cascades/data/haarcascade_frontalface_default.xml')
eye_cascade = cv2.CascadeClassifier('I:/1.232 Pora/ALL Projects/Face Detection/with real training/lmn try all face/All in/with class/cascades/data//haarcascade_eye.xml')


recognizer = cv2.face.LBPHFaceRecognizer_create()
recognizer.read("I:/1.232 Pora/ALL Projects/Face Detection/with real training/lmn try all face/All in/with class/recognizers/face-trainner.yml")

labels = {"person_name": 1}
with open("I:/1.232 Pora/ALL Projects/Face Detection/with real training/lmn try all face/All in/with class/pickles/face-labels.pickle", 'rb') as f:
...
class MakeDataset:
    ...
    def __init__(self, img):
        ...
        for path, dirs,files in os.walk(self.image_dir):
            self.a1 = os.path.basename(path)
            
        
        self.b1 = self.a1[-1]
        self.b1 = (int(self.b1) + 1) * 2 + random.randint(0, 5555555)
        self.b1 = str(self.b1)
        
        self.dir_n = "I:/1.232 Pora/ALL Projects/Face Detection/with real training/lmn try all face/All in/with class/new_dataset/p" + str(self.b1)
        os.mkdir(self.dir_n)
